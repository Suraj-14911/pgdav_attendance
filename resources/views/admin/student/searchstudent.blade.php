        ...
        <div class="section-body">
            ...
            <div class="row mt-sm-4">
                <div class="col-12 col-md-12 col-lg-7">
                    <div class="card">
                        <form method="post" action="{{ route('admin.student.store') }}" class="needs-validation"
                            novalidate="">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        <label>Email</label>
                                        <input type="text" class="form-control" name="email" placeholder="course"
                                            required="">
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        <label>Course</label>
                                        <input type="text" class="form-control" name="course" placeholder="Email"
                                            required="">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        <label>Section</label>
                                        <input type="text" class="form-control" name="section" placeholder="subject_1"
                                            required="">
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="subject_1" placeholder="Email"
                                            required="">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="subject_2" placeholder="subject_3"
                                            required="">
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="subject_3" placeholder="Email"
                                            required="">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="subject_4" placeholder="subject_5"
                                            required="">
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="subject_5" placeholder="Email"
                                            required="">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="subject_6" placeholder="subject_"
                                            required="">
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="subject_7" placeholder="Email"
                                            required="">
                                        <div class="invalid-feedback">
                                            Please fill in the subject 6
                                        </div>
