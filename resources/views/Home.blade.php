...
<head>
  ...
  <title>PGDAV &mdash; Attendance</title>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{ asset('backened/assets/modules/bootstrap-social/bootstrap-social.css') }}">
...
<body>
  ...
  <footer>In case of Any issue contact Suraj Yadav-- 8957237706</footer>
